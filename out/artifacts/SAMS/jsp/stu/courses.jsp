...
<div style="float: left; margin-right: 20px">
    <div style="width: 198px;height: 180px;border: 1px solid #eeeeee;">
        ...
        <div align="center"><a href="${pageContext.request.contextPath}/jsp/stu/user.jsp"><%=request.getSession().getAttribute("stuName")%>
        </a></div>
...
<div style="float: left;width: 729px;height: auto">
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 0px;">
        <legend><i class="fa fa-commenting" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我的成绩单</legend>
    </fieldset>
...
<script>
    $(document).ready(function () {
        $.post("${pageContext.request.contextPath}/StuServlet?method=showCourses",
