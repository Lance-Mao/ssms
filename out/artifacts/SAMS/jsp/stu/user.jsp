...
<div style="margin-bottom: 20px">
    <ul class="layui-nav">
        ...
        <li class="layui-nav-item">
            <a href="${pageContext.request.contextPath}/jsp/stu/index.jsp"><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;我的主页</a>
            <dl class="layui-nav-child">
                <dd><a href="${pageContext.request.contextPath}/jsp/stu/courses.jsp"><i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;查看成绩</a></dd>
                <dd><a href="${pageContext.request.contextPath}/jsp/stu/user.jsp"><i class="fa fa-id-card-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;个人中心</a></dd>
                <dd><a href="${pageContext.request.contextPath}/jsp/stu/subject.jsp"><i class="fa fa-newspaper-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;课程信息</a></dd>
            </dl>
        </li>
    </ul>
</div>
<div style="float: left; margin-right: 20px">
    <div style="width: 198px;height: 180px;border: 1px solid #eeeeee;" >
        ...
        <div align="center"><a href="${pageContext.request.contextPath}/jsp/stu/user.jsp"><%=request.getSession().getAttribute("stuName")%></a></div>
    ...
    <ul class="layui-nav layui-nav-tree" lay-filter="demo">
        <li class="layui-nav-item layui-nav-itemed">
            ...
            <dl class="layui-nav-child"  style="background-color: #aaaaaa;">
                <dd><a href="${pageContext.request.contextPath}/jsp/stu/index.jsp" style="color: #0C0C0C"><i class="fa fa-university" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;首页表</a></dd>
                <dd><a href="${pageContext.request.contextPath}/jsp/stu/subject.jsp" style="color: #0C0C0C"><i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;我的课程表</a></dd>
                <dd><a href="${pageContext.request.contextPath}/jsp/stu/courses.jsp" style="color: #0C0C0C"><i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;我的成绩单</a></dd>
            </dl>
        </li>
...
<div style="float: left;width: 729px;height: auto">
    <div style="float: left; margin-bottom: 10px; border: 1px solid #C2BE9E; width: 725px;height: 35px;"><p style="font-size: 15px;">  <i class="fa fa-address-card-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;个人中心</p></div>
<div style="float: left; margin-top: 10px;margin-bottom: 10px; border: 1px solid #C2BE9E; width: 725px;height: auto;">
    <div style="margin-top: 20px">
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
            <legend><i class="fa fa-address-card-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;基本信息</legend>
        </fieldset>
        ...
        <table class="layui-table" lay-skin="line">
            ...
            <tr>
                <td>姓名</td>
                <td><%=request.getSession().getAttribute("stuName")%></td>
            </tr>

            <tr>
                <td>当前头像</td>
                <td><img src="${pageContext.request.contextPath}/img/user.jpg"></td>
            </tr>

            <tr>
                <td>平台角色</td>
                <td><%=request.getSession().getAttribute("stuType")%></td>
            </tr>
