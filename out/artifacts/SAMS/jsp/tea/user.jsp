...
<div style="float: left;width: 729px;height: auto">
    ...
    <div style="float: left; margin-top: 10px;margin-bottom: 10px; border: 1px solid #C2BE9E; width: 725px;height: auto;"><p style="font-size: 22px;">
        <div style="margin-top: 20px">
            ...
            <table class="layui-table" lay-skin="line">
                ...
                <tr>
                    <td>姓名</td>
                    <td><%=request.getSession().getAttribute("teaName")%></td>
                </tr>
                ...
                <tr>
                    <td>平台角色</td>
                    <td><%=request.getSession().getAttribute("teaType")%></td>
                </tr>

                <tr>
                    <td>人员编号</td>
                    <td><%=request.getSession().getAttribute("teaNumber")%></td>
                </tr>
                </tbody>
            </table>
        </div>
